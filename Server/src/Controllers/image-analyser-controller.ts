...
import { DocumentItem } from "../types/custom-types.d.js";
...
const analyseDoc = async function (req: Request, res: Response) {
  ...
  try {
    ...
    // You just need to provide the bucket and document name of your s3 bucket and you will get the text back.
      ...
      const findTransportNumber: () => Promise<string | null | undefined> = async () => {
...
const allFilesInS3Array: string[] = allFilesInS3 ? allFilesInS3[0]?.split(',') : [];
